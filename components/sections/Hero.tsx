...
export default function Hero() {
  ...
  return (
    <section
      ...
      className="relative flex flex-col items-center justify-center px-4 sm:px-6 pt-24 sm:pt-28 pb-12 sm:pb-16"
    >
      {/* Background texture */}
      ...
      {/* Floating sensor cards — só xl+ */}
      <div className="hidden xl:block" style={{ position: "absolute", left: "5%", top: "30%", animation: "floatA 5s ease-in-out infinite" }}>
        <SensorFloatCard {...SENSOR_DATA[0]} delay={0} />
      </div>
      <div className="hidden xl:block" style={{ position: "absolute", left: "3%", top: "55%", animation: "floatB 6s ease-in-out infinite 1s" }}>
        <SensorFloatCard {...SENSOR_DATA[2]} delay={200} />
      </div>
      <div className="hidden xl:block" style={{ position: "absolute", right: "5%", top: "28%", animation: "floatB 5.5s ease-in-out infinite 0.5s" }}>
        <SensorFloatCard {...SENSOR_DATA[1]} delay={100} />
      </div>
      <div className="hidden xl:block" style={{ position: "absolute", right: "3%", top: "55%", animation: "floatA 7s ease-in-out infinite 1.5s" }}>
      ...
      <div className="relative z-10 text-center w-full max-w-3xl mx-auto">
        ...
        <div style={{
          ...
          <span style={{
            width: 6, height: 6, borderRadius: "50%", backgroundColor: "#2d8a4e",
            animation: "pulse 2s ease-in-out infinite", display: "inline-block",
          }} />
          <span className="text-badge" style={{ fontSize: 11, letterSpacing: "0.12em", textTransform: "uppercase", fontWeight: 600, color: "#2d8a4e" }}>
        ...
        <h1 style={{
          ...
          marginBottom: 20, animation: "fadeUp 0.6s ease 0.1s both",
          fontFamily: "var(--font-syne)",
        }}>
          Natureza
          <br />
          <span style={{ color: "#1a5c2e", display: "inline-block", position: "relative" }}>
            monitorada.
            <svg viewBox="0 0 300 12" style={{ position: "absolute", bottom: -6, left: 0, width: "100%", opacity: 0.5 }} preserveAspectRatio="none">
        ...
        <div style={{
          ...
          gap: 12, flexWrap: "wrap", animation: "fadeUp 0.6s ease 0.3s both",
        }}>
        ...
        {/* Mini sensor strip — só mobile/tablet (abaixo de xl) */}
        <div className="flex xl:hidden justify-center gap-2 mt-8 flex-wrap">
          {SENSOR_DATA.map(({ icon: Icon, label, value, color }) => (
            <div key={label} style={{
              ...
              <span style={{ color: "var(--text-primary)", fontSize: 11, fontWeight: 700, fontFamily: "var(--font-geist-mono)" }}>{value}</span>
            </div>
          ))}
        </div>
        ...
        <div style={{
          display: "inline-flex", alignItems: "center", gap: 8,
          marginTop: 24, color: "var(--text-muted)", fontSize: 12,
      ...
      <div style={{
        ...
        marginTop: 48, width: "100%", maxWidth: 820,
        ...
        <div style={{
          ...
          backgroundColor: "var(--bg-card)", backdropFilter: "blur(16px)",
          ...
          {METRICS.map((m, i) => (
            ...
            }} className="sm:border-b-0 sm:border-r-metrics">
              <div style={{
                fontSize: 22, fontWeight: 800, color: "#2d8a4e",
      ...
      <style>{`
        ...
        /* Metrics grid: 2 col mobile → 4 col sm+ */
        @media (min-width: 640px) {
          .sm\\:grid-cols-4 { grid-template-columns: repeat(4, 1fr) !important; }
        }
        /* Badge text: menor no mobile */
        @media (max-width: 480px) {
          .text-badge { font-size: 9px !important; letter-spacing: 0.08em !important; }
        }
      `}</style>
    </section>
  );
...
function SensorFloatCard({ icon: Icon, label, value, delta, color, delay }: {
  ...
  return (
    <div style={{
      ...
      boxShadow: "0 8px 32px #00000018", minWidth: 160,
      animation: `fadeUp 0.6s ease ${delay}ms both`,
    }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
        <div style={{
          width: 28, height: 28, borderRadius: 8, backgroundColor: `${color}18`,
