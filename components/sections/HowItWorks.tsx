...
export default function HowItWorks() {
  return (
    <section id="como-funciona" style={{ backgroundColor: "var(--bg)" }} className="py-16 sm:py-28 px-4 sm:px-6">
      <style>{`
        .step-card {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Header */}
        <AnimateOnScroll className="mb-12 sm:mb-20">
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 24 }}>
            ...
            {/* Step count badge — esconde no mobile pequeno */}
        ...
        {/* Steps grid — 1 col mobile, 2 col md, 4 col lg */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5" style={{ marginBottom: 20 }}>
              ...
              <div className="step-card">
                {i < HOW_IT_WORKS.length - 1 && (
                  <div className="step-connector" style={{
                    ...
                    transform: "translateY(-50%)", zIndex: 2, color: "#c8e0cf",
                  }}>
                ...
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 24 }}>
                  <div style={{
                    ...
                    display: "flex", alignItems: "center", justifyContent: "center", color: "#2d8a4e",
                  }}>
                    {iconMap[item.icon]}
                  </div>
                  <span style={{
                    fontSize: 40, fontWeight: 800, lineHeight: 1,
                    color: "var(--border-hover)", fontFamily: "var(--font-geist-mono)", letterSpacing: "-0.04em",
                  }}>
                    {String(item.step).padStart(2, "0")}
                  </span>
                </div>
                <div style={{ width: 32, height: 2, backgroundColor: "#1a5c2e", borderRadius: 999, marginBottom: 16, opacity: 0.4 }} />
                <h3 style={{ color: "var(--text-primary)", fontWeight: 700, fontSize: 16, marginBottom: 10, fontFamily: "var(--font-syne)" }}>
                  {item.title}
                </h3>
        ...
        <AnimateOnScroll delay={200}>
          <div style={{
            ...
            <div>
              <div style={{ color: "var(--text-primary)", fontWeight: 600, fontSize: 14, marginBottom: 4 }}>Variáveis monitoradas</div>
              <div style={{ color: "var(--text-muted)", fontSize: 12 }}>Cada sensor coleta múltiplas variáveis ambientais simultaneamente.</div>
            </div>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {TAGS.map((tag) => (
                <span key={tag} style={{
                  fontSize: 12, padding: "6px 14px", borderRadius: 999,
                  backgroundColor: "#1a5c2e14", color: "#2d8a4e",
                  border: "1px solid #1a5c2e2a", fontWeight: 500,
                }}>
                  {tag}
                </span>
              ))}
