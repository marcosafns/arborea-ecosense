    ...
    <footer style={{ backgroundColor: "var(--bg)", borderTop: "1px solid var(--border)" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        >
          ...
          >
            ...
            <p style={{ color: "var(--text-muted)", fontSize: 13, lineHeight: 1.8, marginBottom: 24, maxWidth: 280 }}>
              ...
              {SOCIAL.map(({ icon: Icon, href, label }) => (
                <Link
                  ...
                  onMouseEnter={e => {
                    ...
                    el.style.borderColor  = "#1a5c2e";
                    el.style.color        = "#2d8a4e";
                    el.style.backgroundColor = "#1a5c2e0d";
                  }}
                  onMouseLeave={e => {
                    const el = e.currentTarget as HTMLAnchorElement;
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <span style={{
              ...
              backgroundColor: "#2d8a4e", display: "inline-block",
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          .flex.flex-col.md\\:grid { grid-template-columns: 1fr 1fr !important; }
        }
      `}</style>
    </footer>
  );
